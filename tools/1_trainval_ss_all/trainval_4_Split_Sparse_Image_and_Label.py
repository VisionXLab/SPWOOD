...
if __name__ == '__main__':
    ...
    # 2. 生成semi sparse数据. 对上一步ori的label部分的稀疏txt，percent设为1, 结果放入到label_image和label_annotation里面
    
    # Required arguments
    parser.add_argument('--imagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/trainval_ori/label_image',
                       help='imagepath for DOTA data')
    parser.add_argument('--labelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/trainval_ori/label_annotation_50',
                       help='labelpath for DOTA data')
    parser.add_argument('--outimagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/50/label_image',
                       help='outimagepath for DOTA data')
    parser.add_argument('--outlabelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/50/label_annotation',
