# 构建原始trainval的json文件。
# 里面保存的是原始图片的文件名，如P0000
# 比例是在原始trainval的数量上进行筛选的。
...
if __name__ == "__main__":
    # 指定文件夹路径
    folder_path = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/1_origin/JPEGImages-trainval"
    
    # 指定选取比例
    ratio = 0.3  # 例如，选取 20% 的图片
    
    # 指定输出 JSON 文件路径
    output_json = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/4/20/0.3.json"
