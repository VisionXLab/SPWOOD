...
# 使用示例
img_folder = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/10/semisparse/10/label_image"  # 替换为存放png图片的文件夹路径
txt_folder = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/10/semisparse/10/label_annotation"    # 替换为存放txt文件的文件夹路径
output_root = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/10/semisparse/10"  # 替换为输出文件夹的路径
