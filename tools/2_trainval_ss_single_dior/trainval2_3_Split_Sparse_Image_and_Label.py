...
wordname_20 = ['golffield','vehicle','Expressway-toll-station','trainstation','chimney','storagetank','ship','harbor','airplane','tenniscourt',
...
if __name__ == '__main__':
    ...
    # Required arguments
    parser.add_argument('--imagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/4/30/trainval_ori/label_image',
                       help='imagepath for DOTA data')
    parser.add_argument('--labelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/4/30/trainval_ori/label_annotation',
                       help='labelpath for DOTA data')
    parser.add_argument('--outimagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/4/30/semisparse/20/label_image',
                       help='outimagepath for DOTA data')
    parser.add_argument('--outlabelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DIOR/4/30/semisparse/20/label_annotation',
    ...
    # Update wordname_20 with percentage if needed
    wordname_20 = ['golffield','vehicle','Expressway-toll-station','trainstation','chimney','storagetank','ship','harbor','airplane','tenniscourt',
        'groundtrackfield','dam','basketballcourt','Expressway-Service-area','stadium','airport','baseballfield','bridge','windmill','overpass']
