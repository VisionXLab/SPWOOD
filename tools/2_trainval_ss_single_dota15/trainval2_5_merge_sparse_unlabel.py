...
if __name__ == "__main__":
    ...
    # 源文件夹路径
    source_folder = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/semi/unlabel_image"
    # 目标文件夹路径
    target_folder = "/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/semisparse/50/unlabel_image"
