...
if __name__ == '__main__':
    ...
    # Required arguments
    parser.add_argument('--imagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/trainval_ori/label_image',
                       help='imagepath for DOTA data')
    parser.add_argument('--labelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/trainval_ori/label_annotation',
                       help='labelpath for DOTA data')
    parser.add_argument('--outimagepath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/semisparse/50/label_image',
                       help='outimagepath for DOTA data')
    parser.add_argument('--outlabelpath', type=str, default='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/DOTA15/trainval_ss2/30/semisparse/50/label_annotation',
    ...
    # Update wordname_16 with percentage if needed
