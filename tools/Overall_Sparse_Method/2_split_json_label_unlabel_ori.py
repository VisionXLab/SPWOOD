...
# 读取 JSON 文件
json_file_path = './trainval_ss1/30/0.3.json'
with open(json_file_path, 'r') as json_file:
    selected_file_names = json.load(json_file)

# 源文件夹路径
source_folder_png = './DOTA1/trainval/images'  # 包含 .png 文件的文件夹
source_folder_txt = './DOTA1/trainval/labelTxt'  # 包含 .txt 文件的文件夹

# 目标文件夹路径
target_folder_png_selected = './trainval_ss1/30/trainval_ori/label_image'  # 目标文件夹，用于存放选中的 .png 文件
target_folder_txt_selected = './trainval_ss1/30/trainval_ori/label_annotation'  # 目标文件夹，用于存放选中的 .txt 文件
target_folder_png_unselected = './trainval_ss1/30/trainval_ori/unlabel_image'  # 目标文件夹，用于存放未选中的 .png 文件
target_folder_txt_unselected = './trainval_ss1/30/trainval_ori/unlabel_annotation'  # 目标文件夹，用于存放未选中的 .txt 文件
