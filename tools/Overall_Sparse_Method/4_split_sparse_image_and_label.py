# 进行分割操作。标注部分的保存比例为1，未标注部分的保存比例为0
...
if __name__ == '__main__':
    ...
    # Required arguments
    parser.add_argument('--imagepath', type=str, default='./adata/trainval_ss1/30/trainval_ori/label_image',
                       help='imagepath for DOTA data')
    parser.add_argument('--labelpath', type=str, default='./adata/trainval_ss1/30/trainval_ori/label_annotation_50',
                       help='labelpath for DOTA data')
    parser.add_argument('--outimagepath', type=str, default='./adata/trainval_ss1/30/semisparse/50/label_image',
                       help='outimagepath for DOTA data')
    parser.add_argument('--outlabelpath', type=str, default='./adata/trainval_ss1/30/semisparse/50/label_annotation',
