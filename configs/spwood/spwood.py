...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="./20/semisparse/1/label_annotation",
            img_prefix="./20/semisparse/1/label_image",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup_unlabeled=dict(
            type=dataset_type,
            ann_file="./20/semisparse/1/unlabel_annotation",
            img_prefix="./20/semisparse/1/unlabel_image",
            classes=classes,
