...
class RotatedDTLossAssignerAssistentV3(nn.Module):
    def __init__(self, cls_channels=len(CLASSES), loss_type='origin', bbox_loss_type='l1', image_class_prompt_path='/workspace/animax/MCL/tools/Assinger_Assistent/image_class_prompt_from_chat.pt'):
    ...
    def forward(self, teacher_logits, student_logits, ratio=0.03, img_metas=None, **kwargs):
        ...
        with torch.no_grad():
            ...
            mask[selected_inds] = 1.0  # selected_inds标记为正样本
