...
class RotatedDTLossAssignerAssistentV3Convert(nn.Module):
    def __init__(self, 
                 cls_channels=len(CLASSES), 
                 loss_type='origin', 
                 bbox_loss_type='l1', 
                 image_class_prompt_path='/workspace/animax/MCL/tools/Assinger_Assistent/image_class_prompt_from_chat_with_percent5_label_modified.pt',
                 angle_coder=dict(
                     type='PSCCoder',
                     angle_version='le90',
                     dual_freq=False,
        ...
        super(RotatedDTLossAssignerAssistentV3Convert, self).__init__()
