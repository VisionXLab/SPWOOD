...
class Semi_GmmLoss7(nn.Module):
    def __init__(self, 
        ...
        super(Semi_GmmLoss7, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds, ratio=0.03, img_metas=None, featmap_sizes=None):
        ...
        with torch.no_grad():
            ...
            print(f"Prompt Selected Indices Count: {len(selected_inds_prompt)}")
            ...
            selected_inds = torch.cat([selected_inds_prompt, class_topk_inds, selected_inds], 0).unique().long()
