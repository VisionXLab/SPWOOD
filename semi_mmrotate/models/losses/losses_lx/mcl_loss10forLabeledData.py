...
class Semi_GmmLossforLabeledData10(nn.Module):
    def __init__(self, 
        ...
        super(Semi_GmmLossforLabeledData10, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds, ratio=0.03, img_metas=None, bbox_head=None, featmap_sizes=None):
        ...
        with torch.no_grad():
            ...
            # 7. 最终的索引
            selected_inds = torch.cat([selected_prompt_indices, selected_inds, pos_inds], 0).unique() # 确保索引有序
            ...
            print(num_final_forlabeleddata)
            print(num_prompt_final_forlabeleddata)
