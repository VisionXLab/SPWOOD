...
class RotatedDTLossAssignerAssistentV3forLabeledData(nn.Module):
    def __init__(self, cls_channels=len(CLASSES), loss_type='origin', bbox_loss_type='l1', image_class_prompt_path='/mnt/nas-new/home/zhanggefan/liuxiang/mcl/Assinger_Assistent/image_class_prompt_from_chat_with_percent5_label_modified.pt',
                    angle_coder=dict(
                     type='PSCCoder',
                     angle_version='le90',
                     dual_freq=False,
    ...
    def forward(self, teacher_logits, student_logits, ratio=0.03, img_metas=None, bbox_head=None, **kwargs):
        ...
        with torch.no_grad():
            ...
            print('Prompt 类别数量:', prompt_count)
