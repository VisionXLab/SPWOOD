...
class Semi_GmmLossforLabeledData8(nn.Module):
    def __init__(self, 
        ...
        super(Semi_GmmLossforLabeledData8, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds, ratio=0.03, img_metas=None, bbox_head=None, featmap_sizes=None):
        ...
        with torch.no_grad():
            ...
            '''
            selected_inds = torch.cat([selected_inds_prompt, selected_inds, pos_inds], 0).unique().long()
