...
class Semi_GmmLoss6(nn.Module):
    def __init__(self, 
        ...
        super(Semi_GmmLoss6, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds, ratio=0.03, img_metas=None, featmap_sizes=None):
        ...
        with torch.no_grad():
            ...
            #print(f"Prompt Threshold: {thres_prompt}, Selected prompt Indices Count: {len(selected_inds_prompt_global)}")
