...
class Semi_GmmLossforLabeledData12(nn.Module):
    def __init__(self, 
        ...
        super(Semi_GmmLossforLabeledData12, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds, ratio=0.03, img_metas=None, bbox_head=None, featmap_sizes=None):
        ...
        return loss_cls, loss_bbox, loss_centerness, num_final_forlabeleddata, num_prompt_final_forlabeleddata
    ...
    def forward(self, teacher_logits, student_logits, ratio=0.03, img_metas=None, bbox_head=None, **kwargs):
        ...
        unsup_losses = dict(
            ...
            num_final_forlabeleddata=sum(losses_list[3]) / len(losses_list[3]),
            num_prompt_final_forlabeleddata=sum(losses_list[4]) / len(losses_list[4])
        )
