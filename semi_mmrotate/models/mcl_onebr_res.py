...
class MCLTeacherOneBrRes(RotatedSemiDetectorOnebr):
    def __init__(self, model: dict, semi_loss_unsup, train_cfg=None, test_cfg=None):
        super(MCLTeacherOneBrRes, self).__init__(
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(MCLTeacherOneBrRes, self).forward_train(imgs, img_metas, **kwargs)  # ???
        ...
        sup_losses = self.student.forward_train(**format_data['sup'], need_res=True)
