...
class SemiPoint2RBoxV2(RotatedSingleStageDetector):
    ...
    def forward_train(self, 
        ...
        feat = self.extract_feat(batch_inputs_all)  # 父类extract_feat中的backbone和neck获得feat
        cls_scores, bbox_preds, angle_preds = self.bbox_head.forward(feat, get_data)  # 从head的forward获得预测结果
