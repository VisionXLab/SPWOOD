...
model = dict(
    ...
    semi_loss_unsup=dict(
        ...
        loss_type='origin', 
        bbox_loss_type='l1',
        image_class_prompt_path= '/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/rsst_prompt/image_class_prompt.pt'),
    # semi_loss_sup=dict(
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/10/label_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/10/label_image",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup_unlabeled=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/10/unlabel_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/30/semisparse/10/unlabel_image",
            classes=classes,
