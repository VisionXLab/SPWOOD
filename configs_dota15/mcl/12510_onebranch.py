...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/10/label_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/10/label_image",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup_unlabeled=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/10/unlabel_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/10/unlabel_image",
            classes=classes,
