...
detector = dict(
    ...
    bbox_head=dict(
        type='SemiMixHead1SparseAll',  # 当下验证sup的sparse gmm效果
        num_classes=15,
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
...
model = dict(
    ...
    semi_loss_sup=dict(
        ...
        loss_type='origin', 
        bbox_loss_type='l1',
        image_class_prompt_path='/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/image_class_prompt_20_50.pt'),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=12800,
        sup_weight=1.0,
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/50/label_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/50/label_image",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup_unlabeled=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/50/unlabel_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss2/20/semisparse/50/unlabel_image",
            classes=classes,
