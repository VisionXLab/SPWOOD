...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/20/semisparse/50/labeled_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/20/semisparse/50/labeled_image",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup_unlabeled=dict(
            type=dataset_type,
            ann_file="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/20/semisparse/50/unlabeled_annotation",
            img_prefix="/inspire/hdd/project/wuliqifa/gaoyubing-240108110053/zw/adata/trainval_ss1/20/semisparse/50/unlabeled_image",
            classes=classes,
